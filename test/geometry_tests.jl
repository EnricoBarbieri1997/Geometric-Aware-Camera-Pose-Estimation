...
using CylindersBasedCameraResectioning.Cylinder: CylinderProperties
...
@testset "get_cylinder_contours" begin
	...
	cylinder.position = [-8.80334, 2.31298, 6.82885]
	cylinder.radiuses = [1.0, 1.0], ([-7.30743, 2.1323, 10.412] - [-9.44826, 0.687196, 3.35754])
