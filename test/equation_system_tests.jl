using CylindersBasedCameraResectioning.Camera: CameraViewPair, random_camera_lookingat_center
...
using CylindersBasedCameraResectioning.Utils: rad2deg, eulerangles_from_rotationmatrix
