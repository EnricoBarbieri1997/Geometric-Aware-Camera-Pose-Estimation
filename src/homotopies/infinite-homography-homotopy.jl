export InfiniteHomographyHomotopy
...
"""
    InfiniteHomographyHomotopy(F::Union{AbstractSystem,System}; start_parameters, target_parameters)
    InfiniteHomographyHomotopy(F::Union{AbstractSystem,System}, start_parameters, target_parameters)
...
function InfiniteHomographyHomotopy(
    ...
    InfiniteHomographyHomotopy(F, start_parameters, target_parameters)
end
function InfiniteHomographyHomotopy(
    F::ModelKit.System,
    p::AbstractVector,
    ...
    InfiniteHomographyHomotopy(fixed(F; compile = compile), p, q)
end
function InfiniteHomographyHomotopy(F::AbstractSystem, p::AbstractVector, q::AbstractVector)
